...
const Shortner = ({login}:{ login: () => void; }) => {
  return (
    <div className=' bg-white  rounded-[12px]  mx-auto p-5 absolute z-[999] '>
      ...
      <button onClick={login} className='bg-[#005AE2] w-full px-4 py-3 rounded-[100px] mt-5 text-white font-semibold text-[14px]'>Trim URL <span></span></button>
