...
const HeroContent = ({login}:{ login: () => void; }) => {
  return (
    <div className='flex flex-col items-center justify-center text-center px-5 lg:px-0' >
        <span className='text-3xl lg:text-5xl font-bold mt-[100px]'>
       ...
       <p className='mt-10'>Advanced <span className='inline-flex flex-col items-center gap-2 text-[#005AE2]'>
        ...
        <div className='flex items-center gap-[56px] mt-8'>
            <button onClick={login} className='px-4 py-3 bg-[#005AE2] rounded-[100px] w-[142px] text-white'>Sign Up</button>
